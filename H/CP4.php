						...
						<div class="Main_Info">
							...
							<div class="row clearfix">
								<div class="col-md-12 col-sm-12">
										...
										<div class="slider-for">
											<div class="slide">
												...
												<div class="Photo_info">
													<div class="title">（標題）展出的話</div>
													<p>活動說明文字活動說明文字活動說明文字說明活動說明文(20字以內)</p>
												</div>
											</div>
											<div class="slide">
												<div class="imgBOX">
											...
											<div class="slide">
												...
												<div class="Photo_info">
													<div class="title">（標題）展出的話</div>
													<p>（說明）光陰無情，總在我們未曾察覺之處，悄然無聲地帶走了什麼：可能是情感，也可能是珍貴的回憶。承載著無數言說的圖書，往往也在這逝水般的時間流動中，逕自衰老、終至毀壞湮滅。然而，在這「成、住、壞、空」的亙古定律之前，我們亦非全然束手無策。且看修護工作者們如何重為整修劣損的圖書文獻，使其復歸舊日之好。</p>
												</div>
											</div>
											<div class="slide">
												<div class="imgBOX">
									...
									<p></p>
									<!-- page foto -->
									<?php require_once('include_pagefoto.php'); ?>
								</div>
							</div>
						</div>
						<!-- 下載列表 -->
